...
RUN comfy model download --url https://huggingface.co/Bakanayatsu/noobai-loras/resolve/main/fdnt5.safetensors --relative-path models/loras --filename fdnt5.safetensors
