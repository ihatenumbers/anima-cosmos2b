...
RUN comfy model download --url https://huggingface.co/Bakanayatsu/noobai-loras/resolve/main/attackonmoe.safetensors --relative-path models/loras --filename attackonmoe.safetensors
...
RUN comfy model download --url https://huggingface.co/Bakanayatsu/noobai-loras/resolve/main/aigri.safetensors --relative-path models/loras --filename aigri.safetensors
