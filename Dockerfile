...
RUN comfy model download --url https://huggingface.co/Bakanayatsu/noobai-loras/resolve/main/meowbah2-000004.safetensors --relative-path models/loras --filename meowbah2-4.safetensors
RUN comfy model download --url https://huggingface.co/Bakanayatsu/noobai-loras/resolve/main/meowbah2.safetensors --relative-path models/loras --filename meowbah2.safetensors
